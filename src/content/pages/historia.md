...
roku zajmuje się produkcją kwiatów balkonowych, rabatowych i chryzantem. Powierzchnia
gospodarstwa to 2,5 tys. metrów kwadratowych pod osłonami (tunele foliowe).

Gospodarstwo jest stale modernizowane. Zostały wymienione kotły centralnego ogrzewania na
...
fuksję, lobelie, niecierpki, dahlie i tunbergie. W naszym gospodarstwie są uprawiane wyłącznie
rośliny pochodzące z oryginalnych mateczników firm zajmujących się produkcją sadzonek.

Zapraszamy do współpracy miłośników kwiatów oraz osoby fizyczne zajmujące się dystrybucją.
Przy dużym zamówieniu możliwość sprzedaży hurtowej.
